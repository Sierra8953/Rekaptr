                                                                ...
                                                                div().flex().flex_wrap().gap_2()
                                                                    ...
                                                                    .child(
                                                                        Button::new("enc-h265", "HEVC")
                                                                            ...
                                                                            .on_click(cx.listener(|this, _, _, cx| { this.form_encoder = "nvh265enc".to_string(); cx.notify(); }))
                                                                    )
                                                                    .child(
                                        ...
                                        Button::new("modal-add", "Add Game Source")
                                            .on_click(cx.listener(|this: &mut Self, _, window, cx| {
                                                if let Some(hwnd) = this.form_hwnd {
                                                    ...
                                                    {
                                                        eprintln!("[UI] Adding new game source: '{}' (process: {:?})", title, target_process);
                                                        ...
                                                        eprintln!("[UI] Successfully updated state for '{}'", title);
                                                    }
