...
pub fn generate_pipeline_string(
    ...
    adapter_index: i32,
    session_id: u64, // NEW: Unique session identifier
    ts_offset_ns: i64, // NEW: Timestamp offset in nanoseconds
) -> String {
    ...
    pipeline.push_str(&format!(
        " splitmuxsink name=sink muxer=\"isofmp4mux fragment-duration=1000000000 decode-time-offset={}\" location=\"{}/seg_{}_%05d.m4s\" max-size-time=2000000000 max-files={} send-keyframe-requests=true reset-muxer=true",
        ts_offset_ns,
