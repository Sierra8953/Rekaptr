...
use adabraka_ui::components::sparkline::{Sparkline, SparklineSize};
...
impl LumaWorkspace {
    pub fn render_dashboard(&self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let bitrate_history = self.app_state.bitrate_history.lock().clone();
                                            ...
                                            HStack::new()
                                                ...
                                                .child(
                                                    div()
                                                        ...
                                                        .h(px(24.0))
                                                        .child(
                                                            Sparkline::new(bitrate_history)
                                                                .size(SparklineSize::Sm)
                                                                .fill_color(theme.tokens.primary.into())
                                                        )
                                                )
                                        )
                                    })
