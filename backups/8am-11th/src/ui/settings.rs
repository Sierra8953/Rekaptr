...
use adabraka_ui::navigation::tabs::{Tabs, TabItem, TabPanel, TabVariant};
use crate::ui::LumaWorkspace;
use crate::config::{VideoSettings, AppConfig};
use std::sync::Arc;
...
impl LumaWorkspace {
    pub fn render_settings_view(&self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let exe_input = self.form_custom_process_exe.clone();
        let title_input = self.form_custom_process_title.clone();
                                    ...
                                    .on_change({
                                        ...
                                        move |index, _window, cx| {
                                            ...
                                            let _ = view_handle.update(cx, |this, cx| {
                                                this.settings_tab_index = index;
                                                cx.notify();
                                            });
                                        }
                                    })
                                    .tabs(vec![
                                        TabItem::new(0, "General").icon("settings"),
                                        TabItem::new(1, "Storage").icon("folder"),
                                        TabItem::new(2, "Games").icon("layout-dashboard"),
                                    ])
                                    .panels(vec![
                                        // Panel 0: General
                                        TabPanel::new(move || {
                                                            ...
                                                            VStack::new()
                                                                ...
                                                                .child(
                                                                    HStack::new()
                                                                        ...
                                                                        .items_center()
                                                                        .child(
                                                                            adabraka_ui::components::input::Input::new(&exe_input)
                                                                                .placeholder("Process Name (e.g. game.exe)")
                                                                                .w(px(200.0))
                                                                        )
                                                                        .child(
                                                                            adabraka_ui::components::input::Input::new(&title_input)
                                                                        ...
                                                                        .child({
                                                                            ...
                                                                            Button::new("add-mapping", "Add Mapping")
                                                                                ...
                                                                                .on_click(move |_, window, cx| {
                                                                                    let _ = view_handle.update(cx, |this, cx| {
                                                                                        let exe = exe_input.read(cx).content.clone().to_string();
                                                                                        let title = title_input.read(cx).content.clone().to_string();
                                                                                        if !exe.is_empty() && !title.is_empty() {
                                                                                            let mut config = crate::config::AppConfig::load();
                                                                                            config.custom_process_mapping.insert(exe, title);
                                                                                            config.save();
                                                                                            exe_input.update(cx, |s, cx| s.set_value("", window, cx));
                                                                                    ...
                                                                                    HStack::new()
                                                                                        ...
                                                                                        .child({
                                                                                            ...
                                                                                            Button::new(SharedString::from(format!("del-map-{}", exe)), "Remove")
                                                                                                ...
                                                                                                .size(ButtonSize::Sm)
                                                                                                .on_click(move |_, _, cx| {
                                                                                                    let _ = view_handle.update(cx, |_, cx| {
