//! Settings view — storage management, global video/audio defaults, and GPU adapter selection.
//!
//! Mostly declarative UI layout code. Storage calculations (clips vs. session buffer sizes)
//! run on a background thread to avoid blocking the UI during directory traversal.
                                        ...
                                        HStack::new()
                                            ...
                                            .child({
                                                ...
                                                div()
                                                    ...
                                                    .child(Icon::new("video").size(px(16.0)))
                                                    .child("Output")
                                            })
                                            .child({
                                                let is_active = current_tab == 2;
                                                let view_handle = view_handle.clone();
                                                div()
                                                    .id("tab-storage")
                                                    .flex()
                                                                        ...
                                                                        VStack::new()
                                                                            ...
                                                                            .child(
                                                                                HStack::new()
                                                                                    ...
                                                                                    .child(
                                                                                        div().flex_1().child(
                                                                                            Input::new(&self.storage_path_input).placeholder("E:\\LumaRecordings")
                                                                                        )
                                                                                    )
                                                                                    .child({
                                                                                        let view_handle = view_handle.clone();
                                                                                        Button::new("save-storage-path", "Save")
                                                                                            .variant(ButtonVariant::Outline)
                                                                                            .on_click(move |_, _, cx| {
                                                                                                let _ = view_handle.update(cx, |this, cx| {
                                                                                                    let new_path = this.storage_path_input.read(cx).content.trim().to_string();
                                                                                                    if new_path.is_empty() { return; }
                                                                                                    crate::utils::set_storage_root(std::path::PathBuf::from(&new_path));
                                                                                                    if let Some(any_window) = cx.windows().first() {
                                                                                                        let _ = any_window.update(cx, |_, window, cx| {
                                                                                                            this.show_toast("Storage Path Updated", Some("Restart Luma for the change to take full effect"), adabraka_ui::overlays::toast::ToastVariant::Success, window, cx);
                                                                                                        });
                                                                                                    }
                                                                                                });
                                                                                            })
                                                                            ...
                                                                            .child(div().text_xs().text_color(theme.tokens.muted_foreground).child("Restart required after changing the storage path."))
                                                                    )
                                                                    .child(
                                                                        HStack::new()
                                                                            .justify_between()
                                                ...
                                                1 => {
                                                    ...
                                                    VStack::new()
                                                        ...
                                                        .child(
                                                            VStack::new()
                                                                .gap_1()
                                                                .child(div().font_weight(FontWeight::SEMIBOLD).text_lg().child("Global Output Quality"))
                                                                .child(div().text_sm().text_color(theme.tokens.muted_foreground).child("These settings are applied by default when adding a new source."))
                                                        )
                                                        // Codec & Format card
                                                        .child(
                                                            Card::new().content(
                                                                VStack::new()
                                                                    .p_6()
                                                                    .gap_4()
                                                                    .child(div().text_sm().font_weight(FontWeight::SEMIBOLD).text_color(theme.tokens.muted_foreground).child("CODEC & FORMAT"))
                                                                    .child(
                                                                        HStack::new()
                                                                            .gap_4()
                                                                            .child(
                                                                                VStack::new()
                                                                                    ...
                                                                                    .child(
                                                                                        div().flex().flex_wrap().gap_2()
                                                                                            .child(Button::new("enc-av1-glob", "AV1").variant(if self.form_encoder == "nvav1enc" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx: &mut Context<LumaWorkspace>| { this.form_encoder = "nvav1enc".to_string(); cx.notify(); })))
                                                                                            .child(Button::new("enc-h265-glob", "HEVC").variant(if self.form_encoder == "nvh265enc" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx: &mut Context<LumaWorkspace>| { this.form_encoder = "nvh265enc".to_string(); cx.notify(); })))
                                                                                            .child(Button::new("enc-h264-glob", "H.264").variant(if self.form_encoder == "nvh264enc" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx: &mut Context<LumaWorkspace>| { this.form_encoder = "nvh264enc".to_string(); cx.notify(); })))
                                                                                    )
                                                                            )
                                                                            .child(
                                                                                VStack::new()
                                                                                    ...
                                                                                    .child(
                                                                                        HStack::new()
                                                                                            .gap_2()
                                                                                            .child(Button::new("rc-cqp-glob", "CQP").variant(if self.form_rate_control == 0 { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_rate_control = 0; cx.notify(); })))
                                                                                            .child(Button::new("rc-vbr-glob", "VBR").variant(if self.form_rate_control == 1 { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_rate_control = 1; cx.notify(); })))
                                                                                    )
                                                                            )
                                                                    )
                                                                    .child(
                                                                        HStack::new()
                                                                            ...
                                                                            .child(
                                                                                VStack::new()
                                                                                    ...
                                                                                    .child(
                                                                                        div().flex().flex_wrap().gap_2()
                                                                                            .child(Button::new("res-4k-glob", "4K").variant(if self.form_resolution == "3840x2160" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_resolution = "3840x2160".to_string(); cx.notify(); })))
                                                                                            .child(Button::new("res-1440p-glob", "1440p").variant(if self.form_resolution == "2560x1440" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_resolution = "2560x1440".to_string(); cx.notify(); })))
                                                                                            .child(Button::new("res-1080p-glob", "1080p").variant(if self.form_resolution == "1920x1080" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_resolution = "1920x1080".to_string(); cx.notify(); })))
                                                                                    )
                                                                            )
                                                                            .child(
                                                                                VStack::new()
                                                                                    ...
                                                                                    .child(
                                                                                        div().flex().flex_wrap().gap_2()
                                                                                            .child(Button::new("fps-30-glob", "30").variant(if self.form_fps == 30 { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_fps = 30; cx.notify(); })))
                                                                                            .child(Button::new("fps-60-glob", "60").variant(if self.form_fps == 60 { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_fps = 60; cx.notify(); })))
                                                                                            .child(Button::new("fps-120-glob", "120").variant(if self.form_fps == 120 { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_fps = 120; cx.notify(); })))
                                                                                    )
                                                                            )
                                                                    )
                                                            )
                                                        ...
                                                        .child(
                                                            Card::new().content(
                                                                VStack::new()
                                                                    .p_6()
                                                                    .gap_4()
                                                                    .child(div().text_sm().font_weight(FontWeight::SEMIBOLD).text_color(theme.tokens.muted_foreground).child("QUALITY"))
                                                                    .child(
                                                                        VStack::new()
                                                                            .gap_1()
                                                                            ...
                                                                            .child(
                                                                                HStack::new()
                                                                                    .gap_4()
                                                                                    .items_center()
                                                                                    .child(Button::new("val-dec-glob", "-").variant(ButtonVariant::Outline).on_click(cx.listener(|this, _, _, cx| { if this.form_rate_control == 0 { this.form_cq = (this.form_cq - 1).max(0); } else { this.form_bitrate = (this.form_bitrate - 1000).max(1000); } cx.notify(); })))
                                                                                    ...
                                                                                    .child(Button::new("val-inc-glob", "+").variant(ButtonVariant::Outline).on_click(cx.listener(|this, _, _, cx| { if this.form_rate_control == 0 { this.form_cq = (this.form_cq + 1).min(51); } else { this.form_bitrate = (this.form_bitrate + 1000).min(100000); } cx.notify(); })))
                                                                            )
                                                                    )
                                                                    .child(
                                                                        VStack::new()
                                                                            ...
                                                                            .child(
                                                                                div().flex().flex_wrap().gap_2()
                                                                                    .child(Button::new("pre-p1-glob", "P1 (Fastest)").variant(if self.form_preset == "p1" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_preset = "p1".to_string(); cx.notify(); })))
                                                                                    .child(Button::new("pre-p4-glob", "P4 (Balanced)").variant(if self.form_preset == "p4" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_preset = "p4".to_string(); cx.notify(); })))
                                                                                    .child(Button::new("pre-p7-glob", "P7 (Quality)").variant(if self.form_preset == "p7" { ButtonVariant::Default } else { ButtonVariant::Outline }).on_click(cx.listener(|this, _, _, cx| { this.form_preset = "p7".to_string(); cx.notify(); })))
                                                                            )
                                                                    )
                                                            )
                                                        )
                                                        // Advanced Encoder card
                                                        .child(
                                                            Card::new().content(
                                                                VStack::new()
                                                                    .p_6()
                                                                    .gap_4()
                                                                    .child(div().text_sm().font_weight(FontWeight::SEMIBOLD).text_color(theme.tokens.muted_foreground).child("ADVANCED ENCODER"))
                                                                    .child(
                                                                        VStack::new()
                                                                            .gap_2()
                                                                            .child(
                                                                        ...
                                                                        VStack::new()
                                                                            ...
                                                                            .child(
                                                                                HStack::new()
                                                                                    .gap_4()
                                                                                    .items_center()
                                                                                    .child(Button::new("gop-dec-glob", "-").variant(ButtonVariant::Outline).on_click(cx.listener(|this, _, _, cx| { this.form_gop = (this.form_gop - 10).max(1); cx.notify(); })))
                                                                                    .child(div().p_3().bg(theme.tokens.background).rounded_md().min_w(px(100.0)).child(div().text_center().child(self.form_gop.to_string())))
                                                                                    .child(Button::new("gop-inc-glob", "+").variant(ButtonVariant::Outline).on_click(cx.listener(|this, _, _, cx| { this.form_gop = (this.form_gop + 10).min(1000); cx.notify(); })))
                                                                            )
                                                                    )
                                                            )
                                                        )
                                                        ...
                                                        .child(
                                                            HStack::new()
                                                                .justify_end()
                                                                .child(
                                                                    Button::new("save-global-output", "Save Global Defaults")
                                                                        .variant(ButtonVariant::Default)
                                                                        .on_click(cx.listener(|this, _, window, cx| {
                                                                            let mut config = crate::config::AppConfig::load();
                                                                            config.global_video.encoder = this.form_encoder.clone();
                                                                            config.global_video.resolution = this.form_resolution.clone();
                                                                            config.global_video.fps = this.form_fps;
                                                                            config.global_video.bitrate_kbps = this.form_bitrate;
                                                                            config.global_video.cq_level = this.form_cq;
                                                                            config.global_video.rate_control_index = this.form_rate_control;
                                                                            config.global_video.preset = this.form_preset.clone();
                                                                            config.global_video.zero_latency = this.form_zero_latency;
                                                                            config.global_video.lookahead = this.form_lookahead;
                                                                            config.global_video.spatial_aq = this.form_spatial_aq;
                                                                            config.global_video.temporal_aq = this.form_temporal_aq;
                                                                            config.global_video.gop_size = this.form_gop;
                                                                            config.save();
                                                                            this.show_toast("Settings Saved", Some("Global output defaults updated."), adabraka_ui::overlays::toast::ToastVariant::Success, window, cx);
                                                                        }))
                                                                )
                                                        )
                                                        .into_any_element()
                                                                                        ...
                                                                                        Button::new("buf-save", "Apply")
                                                                                            ...
                                                                                            .on_click(move |_, window, cx| {
                                                                                                let _ = view_handle.update(cx, |this, cx| {
                                                                                                    ...
                                                                                                    config.save();
                                                                                                    crate::utils::trigger_buffer_cleanup();
