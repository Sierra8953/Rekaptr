                                                ...
                                                0 => {
                                                    VStack::new()
                                                        ...
                                                        .child({
                                                            ...
                                                            let encoder_label = match config.global_video.encoder.as_str() {
                                                                "nvav1enc" => "NVENC AV1 (NVIDIA RTX 40+)",
                                                                "nvh265enc" => "NVENC H.265/HEVC (NVIDIA)",
                                                                "nvh264enc" => "NVENC H.264 (NVIDIA)",
                                                                "x264enc" => "x264 (CPU Software)",
                                                                other => other,
                                                            };
                                                            Card::new().content(
                                                                VStack::new()
                                                                    ...
                                                                    .child(
                                                                        HStack::new()
                                                                            ...
                                                                            .child(
                                                                                VStack::new()
                                                                                    .child(div().child("Default Encoder"))
                                                                                    .child(div().text_xs().text_color(theme.tokens.muted_foreground).child("Auto-detected at startup. Change per-source in source settings."))
                                                                            )
                                                                            .child(div().text_color(theme.tokens.primary).font_weight(FontWeight::MEDIUM).child(encoder_label.to_string()))
                                                                    )
                                                                    .child({
                                                                        let view_handle = view_handle.clone();
                                                                        let current_path = config.storage_path.clone();
                                                                        HStack::new()
                                                                            .justify_between()
                                                                            .items_center()
                                                                            ...
                                                                            .child(
                                                                                HStack::new()
                                                                                    .gap_2()
                                                                                    .items_center()
                                                                                    .child(div().text_color(theme.tokens.muted_foreground).max_w(px(400.0)).overflow_hidden().child(current_path))
                                                                                    .child(
                                                                                        Button::new("change-storage-path", "Change")
                                                                                                ...
                                                                                                cx.spawn(|cx: &mut AsyncApp| {
                                                                                                    ...
                                                                                                    async move {
                                                                                                        if let Some(folder) = rfd::AsyncFileDialog::new()
                                                                                                            .set_title("Choose recording storage folder")
                                                                                                            .pick_folder()
                                                                                                            .await
                                                                                                        {
                                                                                                            ...
                                                                                                            let _ = view_handle.update(&mut cx, |this, cx| {
                                                                                                                ...
                                                                                                                if let Some(any_window) = cx.windows().first() {
                                                                                                                    let _ = any_window.update(cx, |_, window, cx| {
                                                                                                                        this.show_toast("Storage Path Updated", Some("New recordings will be saved to the selected folder."), adabraka_ui::overlays::toast::ToastVariant::Success, window, cx);
                                                                                                                    });
                                                                                                                }
                                                                                                                cx.notify();
                                                                                                            });
                                                                    ...
                                                                    .child({
                                                                        let startup_enabled = crate::utils::is_startup_with_windows();
                                                                        let view_handle = view_handle.clone();
                                                                        HStack::new()
                                                                            .justify_between()
                                                                            .items_center()
                                                                            .child(
                                                                                VStack::new()
                                                                                    ...
                                                                                    .child(div().text_xs().text_color(theme.tokens.muted_foreground).child("Launch Luma automatically when you log in."))
                                                                            )
                                                                            .child(
                                                                                Button::new("toggle-startup", if startup_enabled { "ON" } else { "OFF" })
                                                                                    .variant(if startup_enabled { ButtonVariant::Default } else { ButtonVariant::Ghost })
                                                                                    .size(ButtonSize::Sm)
                                                                                    .on_click(move |_, _, cx| {
                                                                                        ...
                                                                                        config.save();
                                                                                        let _ = view_handle.update(cx, |_, cx| cx.notify());
                                                                                    })
                                                                            )
                                                                    })
                                                            )
                                                        ...
                                                        .child({
                                                            let hotkeys = crate::config::AppConfig::load().hotkeys;
                                                            let listening = self.hotkey_listening;
                                                            let hotkey_entries: Vec<(usize, &str, u32, u32)> = vec![
                                                                (0, "Toggle Recording", hotkeys.toggle_recording_vk, hotkeys.toggle_recording_mod),
                                                                (1, "Save Clip", hotkeys.save_clip_vk, hotkeys.save_clip_mod),
                                                                (2, "Toggle Mic Mute", hotkeys.toggle_mic_vk, hotkeys.toggle_mic_mod),
                                                            ];
                                                            Card::new().content(
                                                                VStack::new()
                                                                    .p_6()
                                                                    .gap_4()
                                                                    .child(div().font_weight(FontWeight::SEMIBOLD).text_lg().child("Global Hotkeys"))
                                                                    .child(div().text_xs().text_color(theme.tokens.muted_foreground).child("Click a binding to change it. Press the new key (with optional Ctrl/Alt/Shift). Press Escape to cancel."))
                                                                    .children(hotkey_entries.into_iter().map(|(idx, label, vk, modifiers)| {
                                                                        let is_listening = listening == Some(idx);
                                                                        let display_text = if is_listening {
                                                                            "Press a key...".to_string()
                                                                        } else {
                                                                            format_hotkey(vk, modifiers)
                                                                        };
                                                                        let view_handle = view_handle.clone();
                                                                        HStack::new()
                                                                            .justify_between()
                                                                            ...
                                                                            .child(
                                                                                div()
                                                                                    .id(SharedString::from(format!("hotkey-btn-{}", idx)))
                                                                                    .px_3()
                                                                                    .py_1()
                                                                                    .rounded(px(6.0))
                                                                                    .border_1()
                                                                                    .border_color(if is_listening { theme.tokens.primary } else { theme.tokens.border })
                                                                                    .bg(if is_listening { theme.tokens.accent } else { theme.tokens.background })
                                                                                    .cursor(CursorStyle::PointingHand)
                                                                                    .text_sm()
                                                                                    .font_weight(FontWeight::MEDIUM)
                                                                                    .text_color(if is_listening { theme.tokens.primary } else { theme.tokens.foreground })
                                                                                    .child(display_text)
                                                                                    .on_mouse_down(MouseButton::Left, move |_, window, cx| {
                                                                                        let _ = view_handle.update(cx, |this, cx| {
                                                                                            this.hotkey_listening = Some(idx);
                                                                                            this.hotkey_focus_handle.focus(window);
                                                                                            cx.notify();
                                                                                        });
                                                                                    })
                                                                            )
                                                                    }))
                                                                    .when(listening.is_some(), {
                                                                        let view_handle = view_handle.clone();
                                                                        move |this| this.child(
                                                                            div().text_xs().text_color(theme.tokens.muted_foreground).mt_2()
                                                                                .child("Hotkeys are re-registered on next app launch.")
                                                                        )
                                                                    })
                                                            )
                                                        })
