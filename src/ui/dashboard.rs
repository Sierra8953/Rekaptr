                                        ...
                                        HStack::new()
                                            ...
                                            .child(
                                                HStack::new()
                                                    .gap_2()
                                                    .child(
                                                        Tooltip::new(if is_recording { "Stop Recording" } else { "Record" }).child(
                                                    ...
                                                    .child(
                                                        Tooltip::new("Skip Back 10s").child(
                                                            Button::new("btn-back", "")
                                                    ...
                                                    .child({
                                                        ...
                                                        Tooltip::new(if is_paused { "Play" } else { "Pause" }).child(
                                                            Button::new("btn-play", "")
                                                    ...
                                                    .child(
                                                        Tooltip::new("Skip Forward 30s").child(
                                                            Button::new("btn-fwd", "")
